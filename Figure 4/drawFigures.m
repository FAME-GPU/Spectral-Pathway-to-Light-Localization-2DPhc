...
legend(legend_handles, legend_labels, 'Location', 'north', 'FontSize',16);
...
%% Figure 4h -- Band structure
load("FRE_rectangle_all.mat")
selectfre = FRE;
imagind = [1 : 7];
newind = [8 : 21, 23 : 28];
hax = axes(figure);
...
%% Figure 4i -- Light localization
load("F_data_rectangle_all.mat")
elements = F_data.elements;
nodes = F_data.nodes;
abs_q1_all = F_data.abs_q1_all;
